...
//    private static final double RPM_READY_THRESHOLD = 200;
//
...
//            angleServo.setPosition(smoothServo(currentServoPos, targetServoPos, 0.2));
//        } else {
//            stopShooter();
//            hasRumbled = false;
//        }
...
//
//        // Only run motor if RPM is achievable (within threshold)
...
//        double compensatedFF = kF * (targetRPM / MAX_MOTOR_RPM) * voltageCompFactor;
//
