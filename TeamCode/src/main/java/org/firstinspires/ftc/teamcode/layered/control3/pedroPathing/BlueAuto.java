...
public class BlueAuto extends OpMode {
    ...
    private final Pose startPose = new Pose(33, 135.5, Math.toRadians(0)); // Start Pose of our robot.
    private final Pose scanPose = new Pose(42, 101, Math.toRadians(65));
    private final Pose scorePose = new Pose(42, 102, Math.toRadians(135)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.zz
    private final Pose pickup1Pose = new Pose(42, 84.2, Math.toRadians(180)); // Highest (First Set) of Artifacts from the Spike Mark.
    ...
    private final Pose pickup3Pose = new Pose(42, 35.8, Math.toRadians(180)); // Lowest (Third Set) of Artifacts from the Spike Mark.
    private final Pose pickup3EndPose = new Pose(15, 35.8, Math.toRadians(180));
