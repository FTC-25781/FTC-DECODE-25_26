...
@Autonomous(name = "Blue Auto Close Dont use", group = "Blue")
@Configurable
public class BlueAutoClose extends OpMode {
    ...
    private final Pose startPose = new Pose(122-72, 122, Math.toRadians(135));
    private final Pose scanPose = new Pose(72, 72, Math.toRadians(90));
    private final Pose shootPose = new Pose(80-72, 80, Math.toRadians(45));
